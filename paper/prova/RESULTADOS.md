...
Medido: 3076 bytes em 0.46 s = 6741 B/s (Python puro, um nucleo). xz -9: 1744 bytes; este codec: 1179 bytes.

| motor | e_calc (J/byte) | enlace | limiar (1-r)*e_rede | compensa em 1 envio? | envios p/ empatar |
|---|---|---|---|---|---|
| este codec, Python puro (MEDIDO) | 0.000742 | fibra / datacenter | 1.23e-08 | nao | 60,133 |
| este codec, Python puro (MEDIDO) | 0.000742 | 4G movel | 1.23e-06 | nao | 601 |
| este codec, Python puro (MEDIDO) | 0.000742 | satelite / LoRa | 0.000123 | nao | 6 |
| este codec, Python puro (MEDIDO) | 0.000742 | espaco profundo | 0.0123 | SIM | 1 |
...
| 16 | 33,237 | 65,536 | 15.08 | **+0.92** | 0.0232 |
| 20 | 751,504 | 1,048,576 | 19.33 | **+0.67** | 0.5276 |
