...
Medido: 3076 bytes em 0.44 s = 7058 B/s (Python puro, um nucleo). xz -9: 1744 bytes; este codec: 1179 bytes.

| motor | e_calc (J/byte) | enlace | limiar (1-r)*e_rede | compensa em 1 envio? | envios p/ empatar |
|---|---|---|---|---|---|
| este codec, Python puro (MEDIDO) | 0.000708 | fibra / datacenter | 1.23e-08 | nao | 57,435 |
| este codec, Python puro (MEDIDO) | 0.000708 | 4G movel | 1.23e-06 | nao | 574 |
| este codec, Python puro (MEDIDO) | 0.000708 | satelite / LoRa | 0.000123 | nao | 6 |
| este codec, Python puro (MEDIDO) | 0.000708 | espaco profundo | 0.0123 | SIM | 1 |
...
| 12 | 3,545 | 4,096 | 11.42 | **+0.58** | 0.0024 |
| 16 | 33,237 | 65,536 | 15.08 | **+0.92** | 0.0216 |
| 20 | 751,504 | 1,048,576 | 19.33 | **+0.67** | 0.4942 |
